...
sstTransitionDES<BasicMomentumTransportModel>::Lt() const
{
...
template<class BasicMomentumTransportModel>
tmp<volScalarField::Internal> sstTransitionDES<BasicMomentumTransportModel>::FDES
(
...
template<class BasicMomentumTransportModel>
tmp<volScalarField::Internal>
sstTransitionDES<BasicMomentumTransportModel>::epsilonByk
(
    const volScalarField::Internal& F1,
    const volScalarField::Internal& F2
) const
...
template<class BasicMomentumTransportModel>
sstTransitionDES<BasicMomentumTransportModel>::sstTransitionDES
(
...
template<class BasicMomentumTransportModel>
bool sstTransitionDES<BasicMomentumTransportModel>::read()
{
    if
    (
        sstTransition
